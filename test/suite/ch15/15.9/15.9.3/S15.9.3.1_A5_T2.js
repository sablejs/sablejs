...
if (-2209104343000 !== new Date(1899, 11, 31).valueOf()) {
  $FAIL("#1: Incorrect value of Date");
}

if (-2209017943000 !== new Date(1899, 12, 1).valueOf()) {
  $FAIL("#2: Incorrect value of Date");
}

if (-2209017943000 !== new Date(1900, 0, 1).valueOf()) {
  $FAIL("#3: Incorrect value of Date");
}

if (-115200000 !== new Date(1969, 11, 31).valueOf()) {
...
if (946569600000 !== new Date(1999, 11, 31).valueOf()) {
  $FAIL("#7: Incorrect value of Date");
}

if (946656000000 !== new Date(1999, 12, 1).valueOf()) {
  $FAIL("#8: Incorrect value of Date");
}

if (946656000000 !== new Date(2000, 0, 1).valueOf()) {
  $FAIL("#9: Incorrect value of Date");
}

if (4102329600000 !== new Date(2099, 11, 31).valueOf()) {
  $FAIL("#10: Incorrect value of Date");
}

if (4102416000000 !== new Date(2099, 12, 1).valueOf()) {
  $FAIL("#11: Incorrect value of Date");
}

if (4102416000000 !== new Date(2100, 0, 1).valueOf()) {
