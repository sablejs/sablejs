...
if (-2209017944000 !== new Date(1899, 11, 31, 23, 59, 59).valueOf()) {
  $FAIL("#1: Incorrect value of Date");
}

if (-2209017943000 !== new Date(1899, 12, 1, 0, 0, 0).valueOf()) {
  $FAIL("#2: Incorrect value of Date");
}

if (-2209017943000 !== new Date(1900, 0, 1, 0, 0, 0).valueOf()) {
  $FAIL("#3: Incorrect value of Date");
}

if (-28801000 !== new Date(1969, 11, 31, 23, 59, 59).valueOf()) {
...
if (946655999000 !== new Date(1999, 11, 31, 23, 59, 59).valueOf()) {
  $FAIL("#7: Incorrect value of Date");
}

if (946656000000 !== new Date(1999, 12, 1, 0, 0, 0).valueOf()) {
  $FAIL("#8: Incorrect value of Date");
}

if (946656000000 !== new Date(2000, 0, 1, 0, 0, 0).valueOf()) {
  $FAIL("#9: Incorrect value of Date");
}

if (4102415999000 !== new Date(2099, 11, 31, 23, 59, 59).valueOf()) {
  $FAIL("#10: Incorrect value of Date");
}

if (4102416000000 !== new Date(2099, 12, 1, 0, 0, 0).valueOf()) {
  $FAIL("#11: Incorrect value of Date");
}

if (4102416000000 !== new Date(2100, 0, 1, 0, 0, 0).valueOf()) {
